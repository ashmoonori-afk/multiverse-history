...
export const historicalPolityId = (sourceName: string): ReturnType<typeof parseNationId> =>
  parseNationId(`nat_hist_${sourceSlug(sourceName)}_${stableHash(sourceName)}`);
